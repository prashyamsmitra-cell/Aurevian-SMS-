...
export const ADMIN_ACCOUNT = { email: 'admin@aurelis.edu', password: 'Admin@123', name: 'Alexander Whitfield' }

export const initialStudents: Student[] = [
  { id: 'STU-01', rollNo: 'AUR-2048', name: 'Arjun Mehta', email: 'arjun.mehta@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Computer Science & Engineering', department: 'Computer Science', year: 3, semester: 'Semester VI', status: 'Active', gpa: 8.74, credits: 118, phone: '+91 98200 11234', address: '14 Carmichael Road, Mumbai', guardian: 'Rakesh Mehta', avatarSeed: 'arjun', joinedOn: '2023-07-12' },
  { id: 'STU-02', rollNo: 'AUR-2011', name: 'Ananya Mukherjee', email: 'ananya.mukherjee@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Electronics & Communication', department: 'Electronics', year: 2, semester: 'Semester IV', status: 'Active', gpa: 9.02, credits: 76, phone: '+91 98310 22456', address: '22 Salt Lake, Kolkata', guardian: 'Debashish Mukherjee', avatarSeed: 'ananya', joinedOn: '2024-07-08' },
  { id: 'STU-03', rollNo: 'AUR-1987', name: 'Rohan Banerjee', email: 'rohan.banerjee@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Mechanical Engineering', department: 'Mechanical', year: 4, semester: 'Semester VIII', status: 'Active', gpa: 7.91, credits: 152, phone: '+91 90040 33678', address: '9 Park Street, Kolkata', guardian: 'Sourav Banerjee', avatarSeed: 'rohan', joinedOn: '2022-07-15' },
  { id: 'STU-04', rollNo: 'AUR-2102', name: 'Ishita Sen', email: 'ishita.sen@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Computer Science & Engineering', department: 'Computer Science', year: 1, semester: 'Semester II', status: 'Active', gpa: 8.35, credits: 32, phone: '+91 99870 44890', address: '5 Elgin Road, Kolkata', guardian: 'Subrata Sen', avatarSeed: 'ishita', joinedOn: '2025-07-10' },
  { id: 'STU-05', rollNo: 'AUR-2056', name: 'Aditya Kapoor', email: 'aditya.kapoor@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Business Administration', department: 'Business', year: 3, semester: 'Semester VI', status: 'Active', gpa: 7.64, credits: 114, phone: '+91 98111 55201', address: '3 Golf Links, New Delhi', guardian: 'Anil Kapoor', avatarSeed: 'aditya', joinedOn: '2023-07-11' },
  { id: 'STU-06', rollNo: 'AUR-2077', name: 'Meera Nair', email: 'meera.nair@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Computer Science & Engineering', department: 'Computer Science', year: 2, semester: 'Semester IV', status: 'Active', gpa: 9.21, credits: 78, phone: '+91 97400 66123', address: '18 MG Road, Bengaluru', guardian: 'Prakash Nair', avatarSeed: 'meera', joinedOn: '2024-07-09' },
  { id: 'STU-07', rollNo: 'AUR-1999', name: 'Kabir Malhotra', email: 'kabir.malhotra@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Architecture', department: 'Architecture', year: 4, semester: 'Semester VIII', status: 'On Leave', gpa: 8.02, credits: 148, phone: '+91 98450 77345', address: '27 Civil Lines, Delhi', guardian: 'Vivek Malhotra', avatarSeed: 'kabir', joinedOn: '2022-07-14' },
  { id: 'STU-08', rollNo: 'AUR-2033', name: 'Sanya Iyer', email: 'sanya.iyer@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Computer Science & Engineering', department: 'Computer Science', year: 3, semester: 'Semester VI', status: 'Active', gpa: 8.88, credits: 120, phone: '+91 96540 88456', address: '11 Anna Nagar, Chennai', guardian: 'Ramesh Iyer', avatarSeed: 'sanya', joinedOn: '2023-07-13' },
  { id: 'STU-09', rollNo: 'AUR-2134', name: 'Priya Sharma', email: 'priya.sharma@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Computer Science & Engineering', department: 'Computer Science', year: 2, semester: 'Semester IV', status: 'Active', gpa: 8.56, credits: 74, phone: '+91 99120 12340', address: '42 Bandra West, Mumbai', guardian: 'Rajesh Sharma', avatarSeed: 'priya', joinedOn: '2024-07-15' },
  { id: 'STU-10', rollNo: 'AUR-2089', name: 'Nikhil Gupta', email: 'nikhil.gupta@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Electronics & Communication', department: 'Electronics', year: 3, semester: 'Semester VI', status: 'Active', gpa: 7.92, credits: 110, phone: '+91 98765 54321', address: '8 Sector 7, Noida', guardian: 'Rajendra Gupta', avatarSeed: 'nikhil', joinedOn: '2023-07-14' },
  { id: 'STU-11', rollNo: 'AUR-2145', name: 'Divya Patel', email: 'divya.patel@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Business Administration', department: 'Business', year: 2, semester: 'Semester IV', status: 'Active', gpa: 8.67, credits: 72, phone: '+91 97880 11223', address: '56 Ahmedabad Old City', guardian: 'Vikram Patel', avatarSeed: 'divya', joinedOn: '2024-07-16' },
  { id: 'STU-12', rollNo: 'AUR-1965', name: 'Aryan Singh', email: 'aryan.singh@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Mechanical Engineering', department: 'Mechanical', year: 4, semester: 'Semester VIII', status: 'Active', gpa: 7.45, credits: 156, phone: '+91 98340 22334', address: '15 Safdarjung Enclave, Delhi', guardian: 'Colonel Ajay Singh', avatarSeed: 'aryan', joinedOn: '2022-07-18' },
  { id: 'STU-13', rollNo: 'AUR-2178', name: 'Zara Khan', email: 'zara.khan@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Architecture', department: 'Architecture', year: 2, semester: 'Semester IV', status: 'Active', gpa: 8.78, credits: 68, phone: '+91 96540 98765', address: '32 Red Road, Lucknow', guardian: 'Mohammad Khan', avatarSeed: 'zara', joinedOn: '2024-07-12' },
  { id: 'STU-14', rollNo: 'AUR-2091', name: 'Vedant Reddy', email: 'vedant.reddy@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Computer Science & Engineering', department: 'Computer Science', year: 1, semester: 'Semester II', status: 'Active', gpa: 8.9, credits: 30, phone: '+91 99876 34567', address: '99 Somajiguda, Hyderabad', guardian: 'Srinivas Reddy', avatarSeed: 'vedant', joinedOn: '2025-07-11' },
  { id: 'STU-15', rollNo: 'AUR-2156', name: 'Shreya Verma', email: 'shreya.verma@aurelis.edu', password: DEMO_PASSWORD_STUDENT, program: 'Electronics & Communication', department: 'Electronics', year: 1, semester: 'Semester II', status: 'Active', gpa: 9.14, credits: 28, phone: '+91 97654 11223', address: '71 Indiranagar, Bengaluru', guardian: 'Anil Verma', avatarSeed: 'shreya', joinedOn: '2025-07-09' },
]

export const initialTeachers: Teacher[] = [
  { id: 'TCH-01', name: 'Dr. Priya Rao', email: 'priya.rao@aurelis.edu', password: DEMO_PASSWORD_TEACHER, department: 'Computer Science', designation: 'Professor', subjects: ['Database Systems', 'Operating Systems'], office: 'A-204', status: 'Active', phone: '+91 98200 90011', joinedOn: '2016-06-01', avatarSeed: 'priya' },
  { id: 'TCH-02', name: 'Dr. Vikram Desai', email: 'vikram.desai@aurelis.edu', password: DEMO_PASSWORD_TEACHER, department: 'Computer Science', designation: 'Associate Professor', subjects: ['Machine Learning', 'Computer Networks'], office: 'A-210', status: 'Active', phone: '+91 98330 90022', joinedOn: '2018-01-15', avatarSeed: 'vikram', },
  { id: 'TCH-03', name: 'Dr. Neha Kulkarni', email: 'neha.kulkarni@aurelis.edu', password: DEMO_PASSWORD_TEACHER, department: 'Electronics', designation: 'Professor', subjects: ['Signals & Systems', 'Digital Electronics'], office: 'B-110', status: 'Active', phone: '+91 98450 90033', joinedOn: '2015-08-20', avatarSeed: 'neha' },
  { id: 'TCH-04', name: 'Prof. Sameer Joshi', email: 'sameer.joshi@aurelis.edu', password: DEMO_PASSWORD_TEACHER, department: 'Mechanical', designation: 'Assistant Professor', subjects: ['Thermodynamics', 'Heat Transfer'], office: 'C-002', status: 'Active', phone: '+91 97690 90044', joinedOn: '2020-07-03', avatarSeed: 'sameer' },
  { id: 'TCH-05', name: 'Dr. Ritu Chawla', email: 'ritu.chawla@aurelis.edu', password: DEMO_PASSWORD_TEACHER, department: 'Business', designation: 'Professor', subjects: ['Financial Accounting', 'Auditing'], office: 'D-301', status: 'Active', phone: '+91 98110 90055', joinedOn: '2014-06-11', avatarSeed: 'ritu' },
  { id: 'TCH-06', name: 'Prof. Deepak Kumar', email: 'deepak.kumar@aurelis.edu', password: DEMO_PASSWORD_TEACHER, department: 'Computer Science', designation: 'Associate Professor', subjects: ['Web Development', 'Software Engineering'], office: 'A-215', status: 'Active', phone: '+91 99220 90066', joinedOn: '2019-03-20', avatarSeed: 'deepak' },
  { id: 'TCH-07', name: 'Dr. Anjali Gupta', email: 'anjali.gupta@aurelis.edu', password: DEMO_PASSWORD_TEACHER, department: 'Architecture', designation: 'Assistant Professor', subjects: ['Building Design', 'Structural Analysis'], office: 'E-105', status: 'Active', phone: '+91 98980 90077', joinedOn: '2021-05-12', avatarSeed: 'anjali' },
  { id: 'TCH-08', name: 'Prof. Raj Patel', email: 'raj.patel@aurelis.edu', password: DEMO_PASSWORD_TEACHER, department: 'Business', designation: 'Associate Professor', subjects: ['Marketing Management', 'Business Strategy'], office: 'D-305', status: 'Active', phone: '+91 97760 90088', joinedOn: '2017-09-08', avatarSeed: 'raj' },
  { id: 'TCH-09', name: 'Dr. Shalini Singh', email: 'shalini.singh@aurelis.edu', password: DEMO_PASSWORD_TEACHER, department: 'Electronics', designation: 'Assistant Professor', subjects: ['Microprocessors', 'Embedded Systems'], office: 'B-115', status: 'Active', phone: '+91 98540 90099', joinedOn: '2020-11-15', avatarSeed: 'shalini' },
  { id: 'TCH-10', name: 'Prof. Arjun Verma', email: 'arjun.verma@aurelis.edu', password: DEMO_PASSWORD_TEACHER, department: 'Mechanical', designation: 'Associate Professor', subjects: ['Mechanical Design', 'Fluid Mechanics'], office: 'C-008', status: 'Inactive', phone: '+91 96650 90100', joinedOn: '2018-02-20', avatarSeed: 'arjun_v' },
]
